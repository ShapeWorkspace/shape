...
>(({ className, ...props }, ref) => {
  return <Ariakit.ComboboxList ref={ref} className={cn("tiptap-combobox-list", className)} {...props} />
})
...
>(({ className, ...props }, ref) => {
  return <Ariakit.ComboboxPopover ref={ref} className={cn("tiptap-combobox-popover", className)} {...props} />
})
...
>(({ className, ...props }, ref) => {
  return <Ariakit.Combobox ref={ref} autoSelect {...props} className={cn("tiptap-combobox", className)} />
})
...
>(({ className, ...props }, ref) => {
  return <Ariakit.ComboboxItem ref={ref} className={cn("tiptap-combobox-item", className)} {...props} />
})
