...
import { Menu, MenuButton, MenuContent, MenuGroup, MenuItem } from "@/components/tiptap-ui-primitive/menu"
...
const TableActionGroup = () => {
  ...
  const { deleteAction, duplicateAction, clearContentAction, headerAction, addItems, moveItems, sortItems } =
    useTableActionItems()
...
const TableHandleMenuContent = ({
  ...
  const { isMenuOpen, isDragging, setIsDragging, menuPlacement, handleMenuToggle } = useTableHandleMenu(
    onToggleOtherHandle,
    onOpenChange
  )
